...
/*! \class GameOverState
    \brief Descrie starea in cazul in care jucatorul pierde
 */
public class GameOverState extends GameState {
    ...
    private String[] text ={
            "You've failed to take back the Throne",
            "Press ENTER key to reach Menu"
    };/*< textul scris pe ecran*/

    /*! \fn public GameOverState(GameStateManager gsm)
    ...
    public void draw(Graphics2D g) {
        ...
        g.setFont(font);
        drawCentredString("Game over",640,200,g);
